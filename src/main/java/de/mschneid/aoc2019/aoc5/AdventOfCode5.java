...
public class AdventOfCode5 {
    ...
    public void executeProgram(int[] codes, int position, int inputParam) {
        ...
        switch (opMode) {
            ...
            case MULTIPLY:
                ...
                break;
            case INPUT:
                input(codes, position, inputParam);
                position = position + 2;
                break;
            case OUTPUT:
                output(codes, position, modes);
                position = position + 2;
                break;
            case JUMP_IF_TRUE:
        ...
        executeProgram(codes, position, inputParam);
    }
    ...
    void multiply(int[] codes, int position, int firstParam, int secondParam) {
     ...
     void output(int[] codes, int position, int[] modes) {
